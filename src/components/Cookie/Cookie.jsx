...
<p>If you create an account with us then we will use cookies for
...
<p>When you submit data to through a form such as those found on
...
<ul>
<li>Several partners advertise on our behalf and affiliate
tracking cookies simply allow us to see if our customers have
come to the site through one of our partner sites so that we can
credit them appropriately and where applicable allow our
...
sure whether you need or not it's usually safer to leave cookies
enabled in case it does interact with one of the features you use
 on our site.</p>

 <ul>
 <li>Email: contact@invicious.in</li>
 </ul>
